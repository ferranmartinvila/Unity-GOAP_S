    ...
    void OnGUI()
    {
        ...
        */
        ...
        for (int k = 0; k < num; k++)
        {
            ...
            //Generate the window
            Rect node_rect = GUILayout.Window(node.id, node.window_rect, node_window.DrawNodeWindow, node.name, nodes_UI_configuration.node_window_style, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
